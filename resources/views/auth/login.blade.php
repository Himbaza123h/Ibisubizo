        ...
        <div class="container bg-white">
            <div class="main-container">
                <div class="d-flex shadow main-login rounded">
                            ...
                            <form class="w-100" method="POST" action="">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="phone" name="phone" value="" placeholder="Phone Number"
                                        ...
                                        placeholder="" />
                                    {{-- <span class="text-danger"> AD </span> --}}
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="font-size: 14px; color: #00892B;">
                                        <a href="">{{ __('Forgot Password') }}</a>
                                    </div>
                                </div>
                                <div>
                                    <button type="submit" class="login-btn text-white">SIGN IN</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="side-login border w-100 text-white text-center d-flex justify-content-center align-items-center d-md-flex d-none">
                        <div style="margin-bottom: 50px;">
                            <h3 class="font-semibold text-2xl">Sign in to {{ env('APP_NAME') }}</h3>
                            <p class="my-2 text-md">Don't have an account?</p>
                            <div class="mt-3">
                                <a href="{{ route('register') }}" class="log-btn">
                                    Register now
                                </a>
                            </div>
                        </div>
